...
final readonly class ImportContractTypesFacade
{
    ...
    public function handle(UploadedFile $file): array
    {
        ...
        try {
            ...
            $uploadFilePath = sprintf('%s/contract_types', $this->params->get('upload_file_path'));
            ...
            try {
                ...
                $this->commandBus->dispatch(new CreateImportCommand(kindEnum: ImportKindEnum::IMPORT_CONTRACT_TYPES, statusEnum: ImportStatusEnum::PENDING, file: $file, user: $user));
