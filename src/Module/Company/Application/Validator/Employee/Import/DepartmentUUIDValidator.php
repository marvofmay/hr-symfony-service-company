...
final readonly class DepartmentUUIDValidator implements ImportRowValidatorInterface
{
    ...
    {
        $departmentUUID = $row[EmployeeImportColumnEnum::DEPARTMENT_UUID->value] ?? null;
