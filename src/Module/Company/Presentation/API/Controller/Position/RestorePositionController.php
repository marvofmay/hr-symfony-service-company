...
final class RestorePositionController extends AbstractController
{
    ...
    public function __invoke(string $uuid): JsonResponse
    {
        ...
        return new JsonResponse(['message' => $this->messageService->get('position.restore.success', [], 'positions')], Response::HTTP_OK);
    }
}
