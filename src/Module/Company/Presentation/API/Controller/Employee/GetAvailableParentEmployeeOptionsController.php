...
use App\Module\Company\Application\DTO\Employee\ParentEmployeeOptionsQueryDTO;
...
final class GetAvailableParentEmployeeOptionsController extends AbstractController
{
    ...
    #[Route('/api/employees/parent-options', name: 'api.employees.parent-options', methods: ['GET'])]
    public function __invoke(#[MapQueryString] ParentEmployeeOptionsQueryDTO $queryDTO): JsonResponse
    {
        ...
        try {
            $envelope = $this->queryBus->dispatch(
                new GetAvailableParentEmployeeOptionsQuery($queryDTO)
            );
