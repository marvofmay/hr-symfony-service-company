...
use App\Module\Company\Application\DTO\Company\ParentCompanyOptionsQueryDTO;
...
final class GetAvailableParentCompanyOptionsController extends AbstractController
{
    ...
    #[Route('/api/companies/parent-options', name: 'api.companies.parent-options', methods: ['GET'])]
    public function __invoke(#[MapQueryString] ParentCompanyOptionsQueryDTO $queryDTO): JsonResponse
    {
        ...
        try {
            $envelope = $this->queryBus->dispatch(
                new GetAvailableParentCompanyOptionsQuery($queryDTO)
            );
