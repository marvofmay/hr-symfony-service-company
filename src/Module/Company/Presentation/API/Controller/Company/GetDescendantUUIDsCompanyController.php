...
final class GetDescendantUUIDsCompanyController extends AbstractController
{
    ...
    #[Route('/api/companies/{uuid}/descendant-uuids', name: 'api.companies.descendant-uuids', requirements: ['uuid' => '[0-9a-fA-F-]{36}'], methods: ['GET'])]
