 ...
 */
final class Version20250318103203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE department (uuid CHAR(36) NOT NULL, name VARCHAR(1000) NOT NULL, description VARCHAR(500) DEFAULT NULL, active TINYINT(1) DEFAULT 1 NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, company_uuid CHAR(36) NOT NULL, department_uuid CHAR(36) DEFAULT NULL, INDEX IDX_CD1DE18A92124A48 (company_uuid), INDEX IDX_CD1DE18A736537F3 (department_uuid), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE employee (uuid CHAR(36) NOT NULL, external_uuid VARCHAR(100) DEFAULT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, pesel VARCHAR(11) NOT NULL, employment_from DATE NOT NULL, employment_to DATE DEFAULT NULL, active TINYINT(1) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, company_uuid CHAR(36) NOT NULL, department_uuid CHAR(36) NOT NULL, employee_uuid CHAR(36) DEFAULT NULL, position_uuid CHAR(36) NOT NULL, contract_type_uuid CHAR(36) NOT NULL, role_uuid CHAR(36) NOT NULL, INDEX IDX_5D9F75A192124A48 (company_uuid), INDEX IDX_5D9F75A1736537F3 (department_uuid), INDEX IDX_5D9F75A164A61AE1 (employee_uuid), INDEX IDX_5D9F75A1C2E77EF8 (position_uuid), INDEX IDX_5D9F75A12BE7CD38 (contract_type_uuid), INDEX IDX_5D9F75A16FC02232 (role_uuid), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE roles_access (role_uuid CHAR(36) NOT NULL, access_uuid CHAR(36) NOT NULL, INDEX IDX_ED4E1E356FC02232 (role_uuid), INDEX IDX_ED4E1E3527A636A0 (access_uuid), PRIMARY KEY(role_uuid, access_uuid)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE roles_access ADD CONSTRAINT FK_ED4E1E356FC02232 FOREIGN KEY (role_uuid) REFERENCES role (uuid)');
        $this->addSql('ALTER TABLE roles_access ADD CONSTRAINT FK_ED4E1E3527A636A0 FOREIGN KEY (access_uuid) REFERENCES access (uuid)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE roles_access');
