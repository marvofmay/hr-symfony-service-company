...
class GetIndustriesQuery
{
    public function __construct(
        private readonly IndustriesQueryDTO $queryDTO,
        ...
        $this->filters = array_filter((array) $this->queryDTO, fn ($key) => in_array($key, Industry::getAttributes()), ARRAY_FILTER_USE_KEY);
