...
final readonly class CompanyAlreadyExistsValidator implements ValidatorInterface
{
    ...
    public function validate(CommandInterface|QueryInterface $data): void
    {
        ...
        $nip = $data->nip;
        $regon = $data->regon;
        $companyExists = $this->companyReaderRepository->isCompanyExists($nip, $regon, $companyUUID);
        if ($companyExists) {
