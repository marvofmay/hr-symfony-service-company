...
enum PositionImportColumnEnum: int
{
    ...
    case DYNAMIC_IS_POSITION_WITH_NAME_CODE_ALREADY_EXISTS = 100;
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::POSITION_DESCRIPTION => 'departmentName',
            self::ACTIVE => 'active',
            self::DEPARTMENT_INTERNAL_CODE => 'departmentInternalCode',
            self::DYNAMIC_IS_POSITION_WITH_NAME_CODE_ALREADY_EXISTS => 'isPositionWithNameAlreadyExists',
